...
class Assignment(db.Model):
    ...
    #Foreign key to store the assignment to related employee
    ...
    def __repr__(self):
        return f'<Assisgnment {self.id}, {self.role}, {self.start_date}, {self.end_date}, {self.employee.name}, {self.project.title}>'